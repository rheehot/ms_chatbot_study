...
namespace ChatBotApplication.Extensions
{
    public static class HeroCardExtensions
    {
        public static void AddHeroCard<T>(this IMessageActivity message, string title, string subtitle, IEnumerable<T> options
            , IEnumerable<string> images = default(IEnumerable<string>))
        {
